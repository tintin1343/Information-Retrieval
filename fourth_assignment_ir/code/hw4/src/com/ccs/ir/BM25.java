...
public class BM25 {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			String query_file_path = "C:/Users/Nitin/Assign4/queryFile.txt";
			...
			for (List<String> query : final_query) {
				...
				for (String q : query) {
					...
					if (y > 0) {
						...
						OkapiIDF(client, rankTerm, q.toLowerCase(), avg_doc_length);
					}
					y++;
				}
	...
	private static void writeToFile(List<List<String>> resultOkapi) {
		...
		try {
			...
			File file = new File("C:/Users/Nitin/Assign4/BM-25.txt");
