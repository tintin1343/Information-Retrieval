 ...
 * Changed to the 5th formula*/
public class Proximity4 {
	...
	public static double proximityPerDoc(Integer minSpan, double queryLength, int vocabSize, double docLen) {
